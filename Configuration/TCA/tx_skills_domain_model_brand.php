...
return [
    ...
    'types' => [
        1 => ['showitem' => '--palette--;;language, --palette--;;hide, --palette--;;name, --palette--;;desc, patronages, --palette--;;levels, members, --div--;Import, uuid, imported, --div--;Misc, --palette--;;credit, --palette--;;billing, api_key, created_by_brand, foreign_id'],
    ],
    'palettes' => [
